...
def load_model(checkpoint_path, device):
    ...
    # Replace final layer with Identity for embeddings
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(
        description='Build a FAISS index from brick embeddings.'
    )
    parser.add_argument('--model',    required=True,
                        help='Path to trained embedder .pth')
    parser.add_argument('--data_dir', required=True,
                        help='Directory of canonical views (.png)')
